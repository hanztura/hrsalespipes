...
class Candidate(ContactModel):
    ...
    current_previous_salary = models.TextField(
        blank=True, null=True, verbose_name='current salary and benefits')
    ...
    expected_salary = models.TextField(
        blank=True, null=True, verbose_name='expected salary and benefits')

    # personal details
    nationality = models.CharField(max_length=64, blank=True, db_index=True)
    languages = models.TextField(max_length=1000, blank=True, db_index=True)
